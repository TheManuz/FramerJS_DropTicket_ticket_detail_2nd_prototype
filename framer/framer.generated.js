	...
	},
	{
		...
		"children": [
			...
			},
			{
				...
				"modification": "1519140841"
			}
		],
		"modification": "1218984616"
	}
]
if (typeof(DeviceComponent) !== "undefined") {DeviceComponent.Devices["iphone-6-silver"].deviceImageJP2 = false};
window.Framer.Defaults.DeviceView = {"deviceScale":0.5,"deviceType":"nexus-5-black","contentScale":1,"orientation":0};

window.Framer.Defaults.DeviceComponent = {"deviceScale":0.5,"deviceType":"nexus-5-black","contentScale":1,"orientation":0};

window.FramerStudioInfo = {"deviceImagesUrl":"\/_server\/resources\/DeviceImages","documentTitle":"DropTicket_ticket_detail2.framer"};
